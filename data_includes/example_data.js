var shuffleSequence = seq(sepWith("sep", rshuffle("location_organization", "organization_location", "organization&location")));
...
var items = [
    ...
    [["location_organization", "a"], "AcceptabilityJudgment", {s: "The school that sits in a large valley is culturally diverse."}],
    [["organization_location", "a"], "AcceptabilityJudgment", {s: "The school that is culturally diverse sits in a large valley."}],
    [["organization&location", "a"], "AcceptabilityJudgment", {s: "The school is culturally diverse and sits in a large valley."}],
